...
## Note: this was originally developed to take GC stats output of one file and use it on other files, for example. 
##	I have not updated or worked with this in a long long time.
##	I found early on that using GC stats from one file on itself is almost always the best.
